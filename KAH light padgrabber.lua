...
if pc1 and not pc2 then
        ...
        if adminFlr.Pads:FindFirstChild(game.Players.LocalPlayer.Name.."'s admin") == nil then -- Just persons but no pad
            ...
            for i = 1, 40 do
                ...
                for i = 1, 500 do
                    task.wait()
                    chet(
                        "unpunish/                                                                                                                                     all all all all fuck"
                    )
                end
                wait(1)
                chet("clone all all all all fuck")
                task.spawn(function()
    ...
    for i = 1, 350 do
        ...
        chet(
            "clone                                                                                                                                       all all all all fuck"
        )
        task.wait()
    end
    wait(3.5)
    for i = 1,13 do
        chet("dog all all all all                                                                           fuck")
    end
    for i = 1,13 do
        chet("size all .3")
    end
    for i = 1,13 do
        chet("freeze all all all all                                                                           fuck")
    end
    for i = 1,13 do
        chet("size all 10")
    end
...
elseif pc1 and pc2 then -- This requires both but is easily the most powerful
    task.spawn(function()
        for i = 1,999 do
            ...
            for i = 1,13 do
                chet("shield/all all all all fuck")
            end
            for i = 1,13 do
                chet("dog all all all all fuck")
            end
    ...
    if adminFlr.Pads:FindFirstChild(game.Players.LocalPlayer.Name.."'s admin") == nil then -- None of the gamepasses as well as no pads
        local regen = game:GetService("Workspace").Terrain["GameFolder"].Admin:FindFirstChild("Regen")
        local gpad = game:GetService("Workspace").Terrain["GameFolder"].Admin.Pads:FindFirstChild("Touch to get admin")
        task.spawn(function()
            if not regen and not gpad then
                ...
                until workspace.Terrain.GameFolder.Admin:FindFirstChild("Regen")
                root.Anchored = false
